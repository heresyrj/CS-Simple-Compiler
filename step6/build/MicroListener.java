...
public interface MicroListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MicroParser#if_cond}.
	 * @param ctx the parse tree
	 */
	void enterIf_cond(MicroParser.If_condContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#if_cond}.
	 * @param ctx the parse tree
	 */
	void exitIf_cond(MicroParser.If_condContext ctx);
	/**
	 * Enter a parse tree produced by {@link MicroParser#for_cond}.
	 * @param ctx the parse tree
	 */
	void enterFor_cond(MicroParser.For_condContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#for_cond}.
	 * @param ctx the parse tree
	 */
	void exitFor_cond(MicroParser.For_condContext ctx);
	/**
