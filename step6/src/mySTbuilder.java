 ...
 */
public class mySTbuilder extends MicroBaseListener {
    ...
    public mySTbuilder(Scope wrapperScope)
    {
    ...
    public void exitVar_decl(MicroParser.Var_declContext var_declContext)
    {
        ...
        add_symbol_from_idStack(type, false);
    }
    ...
    public void enterFunc_body(MicroParser.Func_bodyContext func_bodyContext)
    {
        ...
        MicroParser.Func_declContext parent = (MicroParser.Func_declContext) func_bodyContext.getParent();
        MicroParser.Param_declContext paradel = parent.param_decl_list().param_decl();
        if(paradel != null) {
    ...
    public void exitFunc_decl(MicroParser.Func_declContext func_declContext) {
        ...
        //dump id in stack, create symbol, and add to symbol list
        add_symbol_from_idStack("INT", false);//hardCoded as INT
    ...
    private void add_symbol_from_idStack(String type, boolean isPara) {
        ...
        while (!idStack.isEmpty())
        {
            ...
            switch (type) {
                case "INT":
                    newVar = new intSymbol(name, currentScope, isPara);
                    break;
                case "FLOAT":
                    newVar = new floatSymbol(name, currentScope, isPara);
                    break;
                default:
